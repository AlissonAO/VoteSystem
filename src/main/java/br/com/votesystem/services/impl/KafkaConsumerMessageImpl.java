...
public class KafkaConsumerMessageImpl implements IConsumerMessage {
    ...
    public void consume(@Payload final String message, @Header(KafkaHeaders.RECEIVED_TOPIC) final String topic) {
        ...
        switch (topic) {
            case TOPIC_ASSOCIADO:
                handleAssociate(buildAction(message, AssociadoDTO.class));
            break;
            case TOPIC_VOTO_ATA:
                handleMinuteMeeting(buildAction(message, VotacaoAtaDTO.class));
                break;
            case TOPIC_VOTO_SESSAO:
                handlePollMeeting(buildAction(message, VotacaoSessaoDTO.class));
                break;
            case TOPIC_VOTE:
                handleVote(buildAction(message, AssociadoVoteDTO.class));
                break;
        }
    }
     ...
     * @param action
     */
    private void handleAssociate(final Action<AssociadoDTO> action) {
     ...
     * @param action
     */
    private void handleMinuteMeeting(final Action<VotacaoAtaDTO> action) {
     ...
     * @param action
     */
    private void handlePollMeeting(final Action<VotacaoSessaoDTO> action) {
     ...
     * @param action
     */
    private void handleVote(final Action<AssociadoVoteDTO> action) {
