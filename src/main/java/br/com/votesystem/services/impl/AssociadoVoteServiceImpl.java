...
public class AssociadoVoteServiceImpl implements IAssociadoVotoService {
    ...
    public VotoAssociado add(final VotoAssociado value) {
        ...
        try {
            ...
            logger.warn("Voto not be able to compute {} Voto: {}, associate: {}, poll: {}", e,
                    obj,
    ...
    public String add(final AssociadoVoteDTO value) throws Exception {
        ...
        try {
            ...
            logger.warn("Voto not be able to compute {} Voto: {}, associate: {}, minute: {}", e,
                    value.getId(),
    ...
    /**
     * Convert AssociateVotoDTO to AssociateVotoPU
     *
     * @param value
     * @return associateVoto
     */
    @Transactional
    public VotoAssociado convert(AssociadoVoteDTO value) {
        ...
        try {
            ...
            obj = null;
            logger.error("ERROR on CONVERT AssociateVotoDTO to AssociateVotoPU", e);
        }
