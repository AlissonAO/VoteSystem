...
public class ConfigKafka {
	...
	/**
	 * Aqui estão as configuraçoes do KAFKA
	 */
    ...
    @Bean
    public NewTopic kafkaTopicAssociado() {
        return new NewTopic(TOPIC_ASSOCIADO, 1, (short) 1);
    }

  
    @Bean
    public NewTopic kafkaTopicVotoAta() {
        return new NewTopic(TOPIC_VOTO_ATA, 1, (short) 1);
    }

   
    @Bean
    public NewTopic kafkaTopicVotoSessao() {
        return new NewTopic(TOPIC_VOTO_SESSAO, 1, (short) 1);
    }
